...
export default function AdminProductsPage() {
  ...
  if (loading) {
    return <p className="text-sm text-[#9CA3AF]">Loading productsÔÇª</p>;
  }
          ...
          >
            <div className="flex items-center justify-between gap-2">
              ...
              <div className="text-right text-[11px] text-[#9CA3AF]">
                ...
                <div>
                  ...
                  {product.externalId ? ` -À ${product.externalId}` : ""}
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-3 text-[11px] text-[#E5E7EB]">
              ...
              <span className="ml-auto text-[11px] text-[#9CA3AF]">
                Stock:{" "}
                {typeof product.stock === "number" ? product.stock : "ÔÇö"}
              </span>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-2 text-[11px] text-[#9CA3AF]">
              ...
              {product.shippingUk ? (
                <span>UK ship: -ú{product.shippingUk}</span>
              ) : null}
              {product.shippingUs ? (
                <span>US ship: -ú{product.shippingUs}</span>
              ) : null}
            </div>
            ...
            <div className="flex items-center justify-between text-[11px] text-[#9CA3AF]">
              ...
              {savingId === product.id ? (
                <span className="text-[#FBBF24]">SavingÔÇª</span>
              ) : null}
            </div>
          </div>
        ))}
